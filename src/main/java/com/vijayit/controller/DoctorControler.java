...
public String deleteUser(@PathVariable String  docid) {
    ...
    public DoctorEntity saveDoctor(@RequestParam("pic") MultipartFile pic,
                                   ...
                                   @RequestParam String role,@RequestParam String availabledays,@RequestParam String shifttype) {
        return doctorService.saveDoctor(pic, docname, mobile, email, registerid, address, gender, specialization,
      otherservices, experience, qualification, department, hod, pwd, confirmPwd, declaration, startTime,endTime, role,availabledays,shifttype);
    }
...
public DoctorEntity findByStartTime(@PathVariable LocalTime startTime) {
	return doctorService.findByStartTime(startTime);
	    ...
	    public ResponseEntity<DoctorEntity> updateDoctor(
	            ...
	            @RequestParam("role") String role, @RequestParam("availabledays")String availabledays,@RequestParam("shifttype") String shifttype) {
	        DoctorEntity updatedDoctor = doctorService.updateDoctor(
	                ...
	                hod, pwd, confirmPwd, declaration, startTime, endTime, role,availabledays,shifttype);
